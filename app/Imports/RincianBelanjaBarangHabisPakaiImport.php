...
/**
 * Import data Rincian Belanja Barang Habis Pakai dari Excel/CSV untuk
 * satu tahun + satu triwulan. Menu ini HANYA SATU jenis (tidak ada tab
 * utama), jadi TIDAK ADA parameter $jenis di sini (beda dengan
 * RincianPemeliharaanImport/RincianBelanjaModalImport).
 *
 ...
 * lihat RincianBelanjaBarangHabisPakai::hitungTotalHarga()).
 *
 ...
 *
 * Sama seperti import menu lain: TIDAK memakai WithUpserts/uniqueBy() -
 * sesuai jawaban AskUserQuestion 2026-09-11 ("Boleh duplikat"), kolom
 ...
 */
class RincianBelanjaBarangHabisPakaiImport implements ToModel, WithHeadingRow, WithValidation
{
    use Importable;
    ...
    public function model(array $row): Model|array|null
    {
        ...
        return new RincianBelanjaBarangHabisPakai([
            ...
            'total_harga' => RincianBelanjaBarangHabisPakai::hitungTotalHarga($volume, $hargaSatuan),
