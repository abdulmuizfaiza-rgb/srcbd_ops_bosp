...
/**
 * Import data Rincian Pemeliharaan/Jasa Pemeliharaan PC Komputer-
 * Laptop-Printer dll dari Excel/CSV untuk satu jenis ('barang'/'jasa')
 * + satu tahun + satu triwulan.
 *
 ...
 * lihat RincianPemeliharaanPc::hitungTotalHarga()), sama seperti kolom
 * rumus lain di aplikasi ini yang tidak pernah diambil mentah dari
 * input.
 *
 ...
 *
 * Sama seperti RincianPemeliharaanImport (menu Belanja Pemeliharaan
 * Bangunan): import di sini TIDAK memakai WithUpserts/uniqueBy() -
 * sesuai jawaban AskUserQuestion 2026-09-10 ("Boleh duplikat"), kolom
 * Nama Barang boleh berulang, sehingga tidak ada kombinasi kolom yang
 * bisa dijadikan kunci pencocokan baris lama vs baru. Setiap baris pada
 * file yang diimport SELALU masuk sebagai baris/data baru.
 */
class RincianPemeliharaanPcImport implements ToModel, WithHeadingRow, WithValidation
{
    use Importable;
    ...
    public function model(array $row): Model|array|null
    {
        ...
        return new RincianPemeliharaanPc([
            ...
            'total_harga' => RincianPemeliharaanPc::hitungTotalHarga($volume, $hargaSatuan),
