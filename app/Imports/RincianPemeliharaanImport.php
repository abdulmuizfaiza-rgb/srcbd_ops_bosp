...
/**
 * Import data Rincian Pemeliharaan/Jasa Pemeliharaan dari Excel/CSV
 * untuk satu jenis ('barang'/'jasa') + satu tahun + satu triwulan.
 *
 ...
 * lihat RincianPemeliharaan::hitungTotalHarga()), sama seperti kolom
 ...
 *
 * Sama seperti LanggananDayaJasaImport: import di sini TIDAK memakai
 * WithUpserts/uniqueBy() - sesuai jawaban AskUserQuestion 2026-09-10
 * ("Boleh duplikat"), kolom Nama Barang boleh berulang, sehingga tidak
 * ada kombinasi kolom yang bisa dijadikan kunci pencocokan baris lama vs
 * baru. Setiap baris pada file yang diimport SELALU masuk sebagai
 * baris/data baru.
 */
class RincianPemeliharaanImport implements ToModel, WithHeadingRow, WithValidation
{
    use Importable;
    ...
    public function model(array $row): Model|array|null
    {
        ...
        return new RincianPemeliharaan([
            ...
            'total_harga' => RincianPemeliharaan::hitungTotalHarga($volume, $hargaSatuan),
