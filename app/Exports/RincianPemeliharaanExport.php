...
/**
 * Export data Rincian Pemeliharaan/Jasa Pemeliharaan (satu jenis, satu
 * triwulan, satu sekolah) ke Excel - layout & lembar tanda tangan SAMA
 * PERSIS seperti LanggananDayaJasaExport/PenerimaanHonorPtkExport, hanya
 * judul & kolom data yang disesuaikan dengan menu ini. Judul berubah
 * sesuai $jenis: "DAFTAR RINCIAN PEMELIHARAAN BANGUNAN" (barang) atau
 * "DAFTAR RINCIAN JASA PEMELIHARAAN" (jasa) - lihat
 * RincianPemeliharaan::JENIS_OPTIONS.
 *
 ...
 */
class RincianPemeliharaanExport implements FromCollection, ShouldAutoSize, WithCustomStartCell, WithEvents, WithHeadings, WithMapping, WithTitle
{
    ...
    /**
     * @param  SupportCollection<int, RincianPemeliharaan>  $baris
     */
    ...
    {
        $singkatan = $this->jenis === RincianPemeliharaan::JENIS_JASA ? 'Jasa' : 'Barang';

        return 'Pemeliharaan '.$singkatan.' TW'.$this->triwulan;
    }
    ...
    {
        $judul1 = strtoupper('DAFTAR '.RincianPemeliharaan::JENIS_OPTIONS[$this->jenis]);
