...
/**
 * Export data Rincian Pemeliharaan/Jasa Pemeliharaan PC Komputer-
 * Laptop-Printer dll (satu jenis, satu triwulan, satu sekolah) ke Excel
 * - layout & lembar tanda tangan SAMA PERSIS seperti
 * RincianPemeliharaanExport (menu Belanja Pemeliharaan Bangunan), hanya
 * judul & kolom data yang disesuaikan dengan menu ini. Judul berubah
 * sesuai $jenis: "DAFTAR RINCIAN PEMELIHARAAN PC KOMPUTER-LAPTOP-
 * PRINTER DLL" (barang) atau "DAFTAR RINCIAN JASA PEMELIHARAAN
 * PC-LAPTOP-PRINTER DLL" (jasa) - lihat RincianPemeliharaanPc::JENIS_OPTIONS.
 *
 ...
 * aplikasi ini yang tidak pernah menyertakan nomor urut): Kode UPB,
 * NPSN, Nama Sekolah, Nama Barang, Nama Merk Barang, Volume, Satuan,
 * Harga Satuan, Total Harga, Asal Usul, Tanggal, Keterangan.
 *
 ...
 */
class RincianPemeliharaanPcExport implements FromCollection, ShouldAutoSize, WithCustomStartCell, WithEvents, WithHeadings, WithMapping, WithTitle
{
    ...
    /**
     * @param  SupportCollection<int, RincianPemeliharaanPc>  $baris
     */
    ...
    {
        $singkatan = $this->jenis === RincianPemeliharaanPc::JENIS_JASA ? 'Jasa' : 'Barang';

        return 'Pemeliharaan PC '.$singkatan.' TW'.$this->triwulan;
    }
    ...
    {
        $judul1 = strtoupper('DAFTAR '.RincianPemeliharaanPc::JENIS_OPTIONS[$this->jenis]);
