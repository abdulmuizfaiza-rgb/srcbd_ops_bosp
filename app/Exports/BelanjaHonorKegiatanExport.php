...
/**
 * Export data Belanja Honor Kegiatan/Belanja Makan & Minum/Belanja
 * Perjalanan Dinas (satu jenis/tab utama, satu triwulan, satu sekolah)
 * ke Excel - pola disalin PERSIS dari LanggananDayaJasaExport (layout &
 * lembar tanda tangan sama), hanya judul & nama kolom Uraian/Tanggal
 * yang disesuaikan dengan menu ini. Judul berubah sesuai $jenis (lihat
 * BelanjaHonorKegiatan::JENIS_OPTIONS) - sama seperti pola
 * RincianPemeliharaanExport (Part 17/20).
 *
 ...
 */
class BelanjaHonorKegiatanExport implements FromCollection, ShouldAutoSize, WithCustomStartCell, WithEvents, WithHeadings, WithMapping, WithTitle
{
    ...
    /**
     * @param  SupportCollection<int, BelanjaHonorKegiatan>  $baris
     */
    ...
    public function title(): string
    {
        $singkatan = match ($this->jenis) {
            BelanjaHonorKegiatan::JENIS_MAKAN_MINUM => 'Makan Minum',
            BelanjaHonorKegiatan::JENIS_PERJALANAN_DINAS => 'Perjalanan Dinas',
            default => 'Honor Kegiatan',
        };

        return $singkatan.' TW'.$this->triwulan;
    }
    ...
    {
        $judul1 = match ($this->jenis) {
            BelanjaHonorKegiatan::JENIS_MAKAN_MINUM => 'DAFTAR BELANJA MAKAN & MINUM KEGIATAN',
            BelanjaHonorKegiatan::JENIS_PERJALANAN_DINAS => 'DAFTAR BELANJA PERJALANAN DINAS',
            default => 'DAFTAR BELANJA HONOR KEGIATAN',
        };
