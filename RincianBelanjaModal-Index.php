...
class Index extends Component
{
     ...
     * Rincian Belanja Modal Aset Tetap Lainnya (KIB E)). Triwulan aktif
     * TIDAK direset - kalau user sedang di TW-2 lalu pindah tab utama,
     * tetap di TW-2 pada tab utama yang baru.
     */
    public function pindahTabUtama(string $jenis): void
    {
        if (! array_key_exists($jenis, RincianBelanjaModal::JENIS_OPTIONS)) {
            return;
        }
