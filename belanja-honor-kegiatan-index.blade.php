                            ...
                            @forelse ($daftarSekolah as $sekolah)
                                ...
                                <tbody wire:key="honor-kegiatan-grup-{{ $sekolah->id }}" x-data="{ terbuka: false }" class="divide-y divide-slate-100 border-b-2 border-slate-200">
                                    ...
                                    @foreach ($sekolah->belanjaHonorKegiatan as $row)
                                        ...
                                        <tr wire:key="honor-kegiatan-baris-{{ $row->id }}" x-show="terbuka" x-cloak>
                                            ...
                                            <td class="px-1 py-1.5 whitespace-nowrap">
                                                <input type="text" wire:model.blur="baris.{{ $row->id }}.uraian" class="w-40 text-xs rounded px-1.5 py-1.5 border {{ $errors->has('baris.'.$row->id.'.uraian') ? 'border-red-400 focus:border-red-500 focus:ring-red-400' : 'border-blue-300 focus:border-blue-500 focus:ring-blue-400' }} focus:ring-1 focus:outline-none">
                                    ...
                                    <tr wire:key="honor-kegiatan-baru-{{ $sekolah->id }}" class="bg-blue-50/40" x-show="terbuka" x-cloak>
                                        ...
                                        <td class="px-2 py-2 whitespace-nowrap font-medium text-slate-800">{{ $sekolah->nama_sekolah ?? '-' }}</td>
                                        <td class="px-1 py-1.5 whitespace-nowrap">
                                            <input type="text" wire:model.blur="baris.{{ $idBaru }}.uraian" placeholder="Uraian" class="w-40 text-xs rounded px-1.5 py-1.5 border {{ $errors->has('baris.'.$idBaru.'.uraian') ? 'border-red-400 focus:border-red-500 focus:ring-red-400' : 'border-dashed border-blue-300 focus:border-blue-500 focus:ring-blue-400' }} focus:ring-1 focus:outline-none">
                            ...
                            @if ($daftarSekolah->isNotEmpty())
                                <tbody>
                                    <tr class="bg-slate-200 font-bold text-slate-800 border-t-2 border-slate-400">
                                        <td colspan="7" class="px-2 py-2.5 text-right">
                                            {{ match ($tabUtama) {
