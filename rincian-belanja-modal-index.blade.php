                    ...
                    <nav class="flex flex-wrap gap-3">
                        @foreach ($triwulanOptions as $value => $label)
                            @php
                                ...
                                $labelTab = $tabUtama === \App\Models\RincianBelanjaModal::JENIS_ASET_TETAP_LAINNYA
                                    ? 'Belanja Modal Aset Tetap Lainnya (KIB E)'
                                    : 'Belanja Modal Peralatan & Mesin (KIB B)';
                            @endphp
                            <button
                                type="button"
