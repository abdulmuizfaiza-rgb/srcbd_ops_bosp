...
Halo <?php echo new \Illuminate\Support\EncodedHtmlString($user->display_name); ?> (<?php echo new \Illuminate\Support\EncodedHtmlString($user->level_akses_label); ?>),

Berikut token verifikasi akses untuk membuka halaman login **<?php echo new \Illuminate\Support\EncodedHtmlString(config('app.name')); ?>**:
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<div style="font-size:28px; letter-spacing:6px; text-align:center; font-weight:bold;"><?php echo new \Illuminate\Support\EncodedHtmlString($token); ?></div>
...
<?php endif; ?>
<?php /**PATH D:\Aplikasi SRCBD_OPS_BOSP\srcbd-ops-bosp-source\resources\views/emails/token-verifikasi-akses.blade.php ENDPATH**/ ?>