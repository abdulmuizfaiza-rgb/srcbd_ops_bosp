                            ...
                            @forelse ($daftarSekolah as $sekolah)
                                ...
                                <tbody wire:key="rincian-pemeliharaan-pc-grup-{{ $sekolah->id }}" x-data="{ terbuka: false }" class="divide-y divide-slate-100 border-b-2 border-slate-200">
                                    ...
                                    <tr wire:key="rincian-pemeliharaan-pc-total-sekolah-{{ $sekolah->id }}" class="bg-slate-100 font-bold text-slate-700 border-t-2 border-slate-300" x-show="terbuka" x-cloak>
                                        <td colspan="9" class="px-2 py-2 text-right">{{ $tabUtama === \App\Models\RincianPemeliharaanPc::JENIS_JASA ? 'Jumlah Rincian Jasa Pemeliharaan PC-Laptop-Printer dll' : 'Jumlah Rincian Pemeliharaan PC Komputer-Laptop-Printer dll' }}</td>
                            ...
                            @if ($daftarSekolah->isNotEmpty())
                                <tbody>
                                    <tr class="bg-slate-200 font-bold text-slate-800 border-t-2 border-slate-400">
                                        <td colspan="9" class="px-2 py-2.5 text-right">{{ $tabUtama === \App\Models\RincianPemeliharaanPc::JENIS_JASA ? 'Jumlah Rincian Jasa Pemeliharaan PC-Laptop-Printer dll Seluruh Sekolah' : 'Jumlah Rincian Pemeliharaan PC Komputer-Laptop-Printer dll Seluruh Sekolah' }}</td>
